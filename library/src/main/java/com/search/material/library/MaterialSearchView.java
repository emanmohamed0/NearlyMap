...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public AutoCompleteTextView mSearchSrcTextView;
    ...
    private void initiateView() {
        ...
        mSearchSrcTextView = (AutoCompleteTextView) mSearchLayout.findViewById(R.id.searchTextView);
...
//        mSuggestionsListView.setVisibility(GONE);
    ...
    private void initSearchView() {
        ...
        mSuggestionsListView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                String a=adapterView.getItemAtPosition(i).toString();
                Log.d("ddd",a);
                mSearchSrcTextView.setText(a);
            }
